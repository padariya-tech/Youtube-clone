...
const registerUser = asyncHandler(async (req, res) => {
    ...
    // validation for username and email not empty
   ...
   const user = await User.create({
    ...
    return res.json(new ApiResponse(200,createdUser,"User created/registered successfully"))
...
// get user detail from parametrs
if (!username?.trim()) {
